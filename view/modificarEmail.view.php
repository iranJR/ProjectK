...
<head>
    ...
    <title>ProjectK - Modificar E-mail</title>
...
<div class='container-fluid text-center'>
    <div class='row content'>
        ...
        <div id = 'divMural' class='col-sm-8 text-left' >
            <div id="divEmail" class="col-sm-10">
                <form id='form' method='post' action='../controller/modificarEmail.action.php?act=save'>
                    <h2><i class='glyphicon glyphicon-pencil'></i>   Modificar E-mail</h2>
                    <h4>Confirme sua senha, para alterar o seu e-mail</h4>
                    <hr>
                    <p>
